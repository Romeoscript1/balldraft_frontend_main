        ...
        <ExploreLayout>
            <div className='flex  max-md:flex-col-reverse items-center h-full '>
                ...
                <div className=' md:w-[50%] max-md:top-0 right-0 absolute text-left max-md:p-[1rem]' data-aos='fade-up'>
                    ...
                    <p className='md:text-xl text-sm font-poppins'>Discover the heartbeat of sports dynamics at our Transfer Market Hub. Immerse yourself in the exhilarating world of player transitions, strategic team moves and groundbreaking deals.</p>
