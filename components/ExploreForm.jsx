        ...
        <ExploreLayout className='formation'>
            ...
            <div className='md:flex items-center h-full relative' data-aos="fade-up" data-aos-delay="300" data-aos-duration="4000">
                <div className='text-left md:w-3/5 md:p-[3rem] p-[1rem]'>
                    ...
                    <p className='md:text-xl text-sm font-poppins'>Make the most of your players’ hot streaks/points. Earn bonus points whenever your players perform outrageously and exceptionally well for several game weeks in a row.</p>
