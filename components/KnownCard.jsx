...
const KnownCard = ({title, desc, img, bg, color}) => {
  ...
  return (
    ...
    <img src={img} alt="" />
      ...
      <button onClick={navigateToDashboard}  className='bg-[#012C51]  text-black border-black border-[1px]  bg-white px-[5.5rem] block py-[0.7rem] my-[2rem] rounded-[30px] p-3 cursor-pointer w-full relative z-100 mr-[1rem]'>Play Now</button>
