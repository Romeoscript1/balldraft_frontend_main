        ...
        <ExploreLayout>
            <div className='md:flex overflow-hidden items-center h-full relative p-1' data-aos="fade-up" data-aos-delay="300" data-aos-duration="4000">
                <div className='text-left md:w-3/5 md:p-[3rem] p-[1rem] z-10'>
                    ...
                    <p className='md:text-xl text-sm mt-2 leading-7 font-poppins'>Kickoff on an even playing field with the Fantasy Draft feature. This enables you to compete against friends or players worldwide by picking your team from a common group of players...</p>
